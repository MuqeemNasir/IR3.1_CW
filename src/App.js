      ...
      <main className="container py-4">
        ...
        <article>
          ...
          <p>
            ...
            quibusdam dolorem reprehenderit rem. Praesentium ipsa tempore
            nesciunt omnis recusandae incidunt non fugiat facilis nisi sapiente
            possimus, repudiandae numquam maxime sequi repellat error ipsam
            inventore deleniti qui ab magnam aut quod assumenda modi!
          </p>
        </article>
        <article>
          <h2>Blog 2</h2>
          ...
          <p>
            ...
            blanditiis ducimus, id sequi quasi odio eligendi necessitatibus
            iusto natus. Minima expedita rem voluptatibus enim saepe aliquid
            labore, consequuntur natus ducimus sit blanditiis sequi beatae.
          </p>
        </article>
      </main>
      <Footer />
